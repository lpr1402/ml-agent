...
import { invalidateTokenCache } from '@/lib/ml-api/token-manager'
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Obter ID da conta a remover
    const { mlAccountId } = await request.json()
    ...
    invalidateTokenCache(mlAccountId)
